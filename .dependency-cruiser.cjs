  ...
  forbidden: [
    ...
    },
    {
      ...
      comment:
        ...
        "preference.service (-> project.repository.getProjectById). Backlog: 74 (was 76).",
      severity: "error",
      from: {
        path: "^packages/server/src/services/",
        pathNot: [
        "^packages/server/src/services/agent-questions\.service\.ts$",
        "^packages/server/src/services/autodrive-stall-warning\.service\.ts$",
        "^packages/server/src/services/bisect\.service\.ts$",
        "^packages/server/src/services/board-column\.service\.ts$",
        "^packages/server/src/services/board-status-enrichment\.ts$",
        "^packages/server/src/services/board-status\.ts$",
        "^packages/server/src/services/budget-estimator\.service\.ts$",
        "^packages/server/src/services/claude-cli\.service\.ts$",
        "^packages/server/src/services/context-packer\.service\.ts$",
        "^packages/server/src/services/cycle-time\.service\.ts$",
        "^packages/server/src/services/dependency-auto-chain\.service\.ts$",
        "^packages/server/src/services/dependency-wave\.service\.ts$",
        "^packages/server/src/services/drive-dashboard\.service\.ts$",
        "^packages/server/src/services/drive-preflight\.service\.ts$",
        "^packages/server/src/services/drive\.service\.ts$",
        "^packages/server/src/services/failure-pattern\.service\.ts$",
        "^packages/server/src/services/file-contention\.service\.ts$",
        "^packages/server/src/services/flake-classifier\.service\.ts$",
        "^packages/server/src/services/followup-workspace\.service\.ts$",
        "^packages/server/src/services/foundational-merge\.service\.ts$",
        "^packages/server/src/services/github-handoff-draft\.service\.ts$",
        "^packages/server/src/services/handoff\.service\.ts$",
        "^packages/server/src/services/issue-activity\.service\.ts$",
        "^packages/server/src/services/issue-ai\.service\.ts$",
        "^packages/server/src/services/issue-merged-commits\.service\.ts$",
        "^packages/server/src/services/issue\.service\.ts$",
        "^packages/server/src/services/merge-cleanup\.service\.ts$",
        "^packages/server/src/services/merge-helpers\.service\.ts$",
        "^packages/server/src/services/merge-queue\.service\.ts$",
        "^packages/server/src/services/milestone\.service\.ts$",
        "^packages/server/src/services/monitor-butler\.ts$",
        "^packages/server/src/services/monitor-cycle-health\.service\.ts$",
        "^packages/server/src/services/phase-artifacts\.service\.ts$",
        "^packages/server/src/services/project-activity\.service\.ts$",
        "^packages/server/src/services/project-health\.service\.ts$",
        "^packages/server/src/services/project-registration\.ts$",
        "^packages/server/src/services/project-scaffold\.ts$",
        "^packages/server/src/services/project-scripts\.service\.ts$",
        "^packages/server/src/services/project-setup\.service\.ts$",
        "^packages/server/src/services/project\.service\.ts$",
        "^packages/server/src/services/quality-metrics\.service\.ts$",
        "^packages/server/src/services/reconciler\.service\.ts$",
        "^packages/server/src/services/review-effectiveness\.service\.ts$",
        "^packages/server/src/services/review\.service\.ts$",
        "^packages/server/src/services/scheduled-run\.service\.ts$",
        "^packages/server/src/services/session-artifacts\.service\.ts$",
        ...
        "^packages/server/src/services/session-stats\.service\.ts$",
        "^packages/server/src/services/showdown\.service\.ts$",
        "^packages/server/src/services/spec-tasks-materialization\.service\.ts$",
        "^packages/server/src/services/sprint-capacity\.service\.ts$",
        "^packages/server/src/services/stack-profile\.service\.ts$",
        "^packages/server/src/services/stale-dev-processes\.ts$",
        "^packages/server/src/services/test-run\.service\.ts$",
        "^packages/server/src/services/ticket-preflight\.service\.ts$",
        "^packages/server/src/services/voice-capture\.service\.ts$",
        "^packages/server/src/services/workflow-fork\.service\.ts$",
        "^packages/server/src/services/workflow\.service\.ts$",
        "^packages/server/src/services/workspace-code-metrics\.service\.ts$",
        "^packages/server/src/services/workspace-crud\.service\.ts$",
        "^packages/server/src/services/workspace-handoff-bundle\.service\.ts$",
        "^packages/server/src/services/workspace-launch-failures\.service\.ts$",
        "^packages/server/src/services/workspace-lifecycle-reconcile\.service\.ts$",
        "^packages/server/src/services/workspace-merge-cleanup\.service\.ts$",
        "^packages/server/src/services/workspace-merge-execution\.service\.ts$",
        "^packages/server/src/services/workspace-merge-prevalidation\.service\.ts$",
        "^packages/server/src/services/workspace-merge\.service\.ts$",
        "^packages/server/src/services/workspace-risk\.service\.ts$",
        "^packages/server/src/services/workspace-scorecard\.service\.ts$",
        "^packages/server/src/services/workspace-session\.service\.ts$",
        "^packages/server/src/services/workspace-summary\.service\.ts$",
        "^packages/server/src/services/workspace-timeline\.service\.ts$",
        ],
      },
      to: { path: "drizzle-orm" },
    },
