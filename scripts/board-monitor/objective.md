...
- **claude:andrena_team_5x_2** [claude:andrena_team_5x_2]: FILL — use aggressively, keep busy at all times (Primary harness - all new workspaces launch on claude:andrena_team_5x_2. Single source of truth (set-provider-default skill).)
...
- **FREE_GB = 8.6** - MAX_NEW_STARTS this cycle would be 3.
