...
- **claude:andrena_team_5x_4** [claude:andrena_team_5x_4]: FILL — use aggressively, keep busy at all times (Primary harness - all new workspaces launch on claude:andrena_team_5x_4. Single source of truth (set-provider-default skill).)
...
- **CAPACITY_HOLD = false** - last measured when this block was generated (tier 0: 9.0GB free). Stale by definition: the live read above is authoritative.
- **FREE_GB = 9.0** - MAX_NEW_STARTS this cycle would be 3.
