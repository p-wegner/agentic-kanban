...
- **codex:default** [claude:default]: FILL — use aggressively, keep busy at all times (Primary harness - all new workspaces launch on codex:default. Single source of truth (set-provider-default skill).)
