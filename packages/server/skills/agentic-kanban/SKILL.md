...
122 tools, by category. Full descriptions: `references/mcp-tools.md`.
...
| Workspaces | `list_workspaces`, `start_workspace`, `launch_workspace`, `relaunch_workspace`, `wait_workspace`, `get_workspace_diff`, `get_workspace_scorecard`, `merge_workspace`, `cancel_merge`, `set_merge_hold`, `release_merge_hold`, `close_workspace`, `reopen_workspace`, `mark_ready_for_merge`, `stop_workspace`, `delete_workspace`, `export_handoff_bundle` |
