...
| `update_issue` | Update an existing issue (title, description, status, priority, type, tags). tags.add / tags.remove take tag NAMES; an added tag is created when the board has none of that name (e.g. 'harness'). |
