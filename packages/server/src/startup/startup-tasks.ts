...
import { reapStaleBaseHealthProbeStampsLogged } from "./base-health-probe-stamp-reaper.js";
...
// #1223 — moved to its own module (self-contained, and startup-tasks.ts sits at the
// god-module gate's 1000-line ceiling). Re-exported so existing importers keep working.
export { reapParentlessChildServers } from "./parentless-child-server-reaper.js";
import { reapParentlessChildServers } from "./parentless-child-server-reaper.js";
...
export async function runCriticalStartupTasks(sessionManager: SessionManager, _deps?: { agentService?: typeof agentServiceType }): Promise<void> {
  ...
  await runNonFatal("reapStaleBaseHealthProbeStamps", reapStaleBaseHealthProbeStampsLogged); // #1223
}
