...
import type { WipHeadroomClamp } from "../services/start-slot-decision.js";

/**
 * #1102: the headroom clamp moved into `services/start-slot-decision.ts` beside
 * `decideStartSlots`, the one slot arithmetic the two monitor loops and
 * `GET /api/projects/:id/autopilot` share. Re-exported so existing importers keep this path.
 */
export { clampWipToHeadroom, type WipHeadroomClamp } from "../services/start-slot-decision.js";
