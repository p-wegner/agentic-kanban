...
// #1089 — moved to lib/ so `routes/workers.ts` (`GET /api/workers/connect-info`) can share the
// SAME steps without importing this CLI module (a route may not import `cli/`).
import { buildWorkerConnectSteps, type WorkerConnectStep } from "../../lib/worker-connect-steps.js";
