// @gate:always-run when:packages/server/src/**,packages/mcp-server/src/** — scans the packages tree for hand-rolled auto_merge reads; that half has no import edge (#647).
