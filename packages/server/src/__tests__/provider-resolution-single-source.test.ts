...
const SELECT_PROVIDER_ALLOWLIST = new Set<string>([
  ...
  // out of routes/butler.ts into the service; #819 then split that service and the
  // allow-list follows the code again, now naming the resolver module itself.
  "services/butler-definitions/launch-config.ts",
]);
