// @gate:always-run when:packages/server/src/scaffold/**,.claude/hooks/** — byte-compares scaffold hooks against .claude/hooks/ outside src/; imports nothing it checks (#538).
