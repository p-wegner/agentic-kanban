// @gate:always-run when:packages/shared/drizzle/**,packages/shared/src/schema/** — scans MIGRATIONS_DIR + the journal for drift; reachable by no single-file diff (#538).
