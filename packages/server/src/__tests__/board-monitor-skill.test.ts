// @gate:always-run when:.claude/skills/board-monitor/**,.codex/skills/board-monitor/**,scripts/board-monitor/** — reads .claude/.codex skill files + a repo-root script, never imported (#538).
