// @gate:always-run when:.claude/skills/quality-metrics-collector/** — reads .claude/skills/quality-metrics-collector/SKILL.md; no import edge to a markdown file (#647).
