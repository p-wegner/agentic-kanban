...
import { gradleWrapper, isKotlinGradle } from "./gradle-detect.service.js";
import { detectStackProfile, readJson, nodeInstallCommand, readFileSafe, type NodePkgJson } from "./stack-detector.service.js";

// detectStackProfile now lives in stack-detector.service (#853 god-file split);
// re-exported here so the ~21 importers keep importing it from stack-profile.service
// unchanged. readJson / nodeInstallCommand / readFileSafe / NodePkgJson are reused below
// by the setup-script derivation.
export { detectStackProfile };
