...
import {
  ...
  isPortInUseError,
  type ComposeRunner,
} from "./workspace-services/compose-runner.js";
...
// The compose CLI adapter moved to `workspace-services/compose-runner.ts` (#728). Re-exported
// here so every existing importer (cli/commands/services.ts, the runner tests, the fake-runner
// test helpers) keeps the same specifier — this module stays the engine's public face.
export { createDefaultComposeRunner, type ComposeRunner } from "./workspace-services/compose-runner.js";
