...
import { installCommitMsgHook } from "./commit-msg-hook.js";
...
// The `commit-msg` hook (BOM strip + TDD gate) lives in its own module — see
// `commit-msg-hook.ts` (#1214 follow-up, kept this file under the god-module ceiling).
