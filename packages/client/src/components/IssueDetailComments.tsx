...
/**
 * The two comment-driven sections of the issue detail view, extracted verbatim
 * from IssueDetailPanel: system comments (preflight clarifications, agent
 * questions, merge attempts) and the user discussion notes input. Behavior is
 * unchanged — both sections still render only when not editing.
 */
