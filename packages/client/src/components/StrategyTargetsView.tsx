...
import { DEFAULT_CONFIG, POLICY_MODE_LABELS, POLICY_MODE_DESCRIPTIONS, KIND_LABELS, BUILTIN_PRESETS, settingsKey, presetsKey, clampWeight, clampPolicy, normalizeConfig, issueSearchText, matchesSegment, deriveRefillFocus, makeAgentBrief, presetMatchesConfig } from "../lib/strategy-targets.js";
