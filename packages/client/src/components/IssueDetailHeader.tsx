      ...
      <div className="flex flex-wrap items-center gap-1">
        {editing ? (
          ...
          <>
            ...
            >
              <Icon className="h-4 w-4" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </button>
            {issue.issueNumber != null && (
            ...
            {canDecompose && (
              ...
              >
                <Icon className="h-4 w-4" d="M4 6h16M4 10h16M4 14h8m-8 4h8" />
              </button>
            )}
            <button
              onClick={onDuplicate}
            ...
            >
              <Icon className="h-4 w-4" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
            </button>
            <button
        ...
        >
          {panelMode === "fullscreen" ? (
            <Icon className="h-4 w-4" d="M9 9L4 4m0 0h5m-5 0v5M15 9l5-5m0 0h-5m5 0v5M9 15l-5 5m0 0h5m-5 0v-5M15 15l5 5m0 0h-5m5 0v-5" />
          ) : panelMode === "modal" ? (
            <Icon className="h-4 w-4" d="M4 8V4m0 0h4M4 4l5 5M20 8V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5M20 16v4m0 0h-4m4 0l-5-5" />
          ) : (
            <Icon className="h-4 w-4" d="M4 8V4m0 0h4M4 4l5 5M20 8V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5M20 16v4m0 0h-4m4 0l-5-5" />
          )}
        </button>
