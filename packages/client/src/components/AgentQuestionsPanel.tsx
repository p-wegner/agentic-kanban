  ...
  return (
    <div className="rounded-xl border border-amber-200 dark:border-amber-700/50 bg-amber-50/60 dark:bg-amber-900/10 shadow-sm" data-testid={`agent-question-${set.toolUseId}`}>
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        >
          <Icon className="w-4 h-4" d="M6 18L18 6M6 6l12 12" />
        </button>
      </div>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {recPending && (
                  <div className="flex items-center gap-1.5 text-[11px] text-amber-600 dark:text-amber-400" data-testid="butler-reviewing">
                    <Spinner className="w-3 h-3 animate-spin" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z" />
                    ...
                    >
                      <div className="flex items-start gap-2">
                        <span className={`mt-0.5 shrink-0 inline-flex items-center justify-center w-4 h-4 ${multi ? "rounded" : "rounded-full"} border ${selected ? "bg-brand-600 border-brand-600 text-white" : "border-gray-300 dark:border-gray-600"}`}>
                          {selected && (
                            <Icon className="w-3 h-3" strokeWidth={3} d="M5 13l4 4L19 7" />
                          )}
                        </span>
