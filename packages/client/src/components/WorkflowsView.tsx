    ...
    <div className="p-4 overflow-y-auto h-full">
      <div className="flex items-center mb-3 gap-2">
        ...
        <div className="flex gap-1 ml-2">
          <button onClick={() => setTab("templates")} className={`text-xs px-2 py-1 rounded ${tab === "templates" ? "bg-brand-600 text-white" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>Templates</button>
        ...
        {templates.map((t) => (
          <div key={t.id} className="border border-gray-200 dark:border-gray-700 rounded-md p-3 bg-white dark:bg-gray-900">
            <div className="flex items-center gap-2">
              ...
              {t.ticketType && <span className="text-[10px] px-1.5 py-0.5 rounded bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-300">{t.ticketType}{t.isDefault ? " default" : ""}</span>}
            </div>
