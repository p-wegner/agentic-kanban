    ...
    <div className="shrink-0 flex items-stretch border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 overflow-x-auto">
          ...
          >
            ...
            {openTabs.length > 1 && (
              <button
                ...
                title="Close tab"
              >
                <Icon className="w-2.5 h-2.5" strokeWidth={2.5} strokeLinecap="round"><path d="M18 6L6 18M6 6l12 12" /></Icon>
              </button>
            )}
          </div>
        );
      ...
      {canOpenMore && (
        <div ref={addTabRef} className="relative shrink-0 flex items-center">
          ...
          >
            <Icon className="w-3.5 h-3.5" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></Icon>
          </button>
