...
const LEGACY_TAB_ROUTES: Record<string, { view: ViewMode; tab: string }> = {
  ...
  // #1066 — the three aggregate dashboards folded into Analytics as tabs.
  "/metrics": { view: "analytics", tab: "metrics" },
  "/workflow-analytics": { view: "analytics", tab: "workflow-analytics" },
  "/insights": { view: "analytics", tab: "insights" },
  // #1067 — capacity and stale work folded into Focus as tabs.
  "/capacity": { view: "focus", tab: "capacity" },
  "/stale-work": { view: "focus", tab: "stale" },
