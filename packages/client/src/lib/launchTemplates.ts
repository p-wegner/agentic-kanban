    ...
    return parsed.flatMap((item): LaunchTemplate[] => {
      ...
      return [{
        ...
        options: {
          ...
          planMode: typeof opts.planMode === "boolean" ? opts.planMode : undefined,
          tddMode: typeof opts.tddMode === "boolean" ? opts.tddMode : undefined,
          requiresReview: typeof opts.requiresReview === "boolean" ? opts.requiresReview : undefined,
          skipSetup: typeof opts.skipSetup === "boolean" ? opts.skipSetup : undefined,
          skipContextPacker: typeof opts.skipContextPacker === "boolean" ? opts.skipContextPacker : undefined,
          isDirect: typeof opts.isDirect === "boolean" ? opts.isDirect : undefined,
        },
