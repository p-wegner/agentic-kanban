...
**Overall: 0.852 — 215 covered · 35 partial · 23 uncovered across 273 behaviours in 15 capabilities.**

| Capability | Score | Covered | Partial | Uncovered | Weakest dimensions |
|---|--:|--:|--:|--:|---|
| project-registration | 0.71 | 11 | 2 | 4 | workflow, error-handling, state-transition |
| codemods | 0.72 | 6 | 2 | 1 | capability, config, boundary |
| mcp-server | 0.72 | 13 | 3 | 4 | permission, workflow, concurrency, config(security egress) |
