...
Passes moved out of `CONTINUE.md` verbatim, newest first. **Nothing here is re-verified or
edited on the way in** — each pass reads exactly as it did when it was the live file, and
therefore describes the state at the time it was written, not the state today. Present tense
belongs to `CONTINUE.md` only.

First archive pass: 2026-08-27, cutting at the 2026-08-24 boundary (`CONTINUE.md` had reached
2279 lines against the ~600-line trigger, and a continuation scraper had already pulled a stale
"Next steps" list out of the 2026-08-23/24 pass and handed it to a fresh session as current).

---

<!-- moved 2026-09-21 from CONTINUE.md, verbatim -->
...
Third archive pass: 2026-09-08, moving the 2026-09-04..09-07 passes (ten sections) out of the
live file, which had reached 693 lines against the ~600-line trigger with its top pass a day old.
Cut at the 2026-09-08 boundary. Note the #1046/#1048/#1049 gate-failure diagnosis appears in
THREE of these passes with three different root causes — %TEMP% exhaustion, then log truncation,
then the board's own resource sweeper reaping the verify tree. Only the last (2026-09-07 evening,
#1059) is correct, and the earlier two say so themselves where they were superseded; they are
kept verbatim because the sequence of wrong diagnoses is the reusable part.

---

Fourth archive pass: 2026-09-11, moving the 2026-09-08..09-10 passes (seven sections: the
overnight-death restart and #1056, the target-only drive scope fix #1071-#1073, the NTFS pnpm
store corruption, the Jira-epic passes, and #1085 / the monitor race) plus the **stale
`## Where this stands (2026-09-08)` standing section**, out of the live file, which had reached
660 lines against the ~150-line cap. Cut at the 2026-09-11 boundary. The standing section was
archived rather than edited because every claim in it had gone false (stable tag, next steps,
#1069/#1070 open); the live file carries a freshly verified one instead.

Fifth archive pass: 2026-09-13, moving the 2026-09-12 (#1102) and 2026-09-11 (three
sections) passes plus the **stale `## Where this stands (2026-09-11)` standing section** out of
the live file, which had reached 236 lines against the ~150-line cap. Cut at the 2026-09-13
boundary. The standing section was archived rather than edited because every claim in it had
gone false (stable tag, 78 unpushed commits, #1097/#1098 open); the live file carries a freshly
verified one instead. Note the 2026-09-11 pnpm-store pass and the 2026-09-13 one describe the
SAME NTFS damage two days apart, with the same shard-quarantine workaround and the same unrun
chkdsk.
